...
# Import model
model = load_model(
    r"/home/iiarroyo/catkin_ws/src/donatello_puzzlebot/traffic_classifier.h5")
...
def findTrafficSign(image, text_s, text_c):
    ...
    if len(cnts) > 0:
        cv2.putText(frame, "Signal Color: Blue", (10, 40),
    ...
    if len(cnts_red) > 0:
        cv2.putText(frame, "Signal Color: Red", (10, 40),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
        for cnt in cnts_red:
            rect = cv2.minAreaRect(cnt)
            box = cv2.boxPoints(rect)
    ...
    if area < min_area:
        cv2.putText(frame, "Signal Shape: Circles", (10, 40),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    ...
    cv2.putText(frame, text, (10, 20),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    cv2.putText(frame, text_2, (10, 150),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    cv2.putText(frame, "Signal Area: "+str(area), (10, 70),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
